...
// Update Donation Request Status (Private)
// - Used to set pending -> inprogress (adds donor info)
// - Used to set inprogress -> done / canceled
app.patch('/api/donation-requests/:id/status', verifyToken, async (req, res) => {
  try {
    ...
    if (status === 'inprogress') {
      // Donor confirms donation request
      // Can only change from pending -> inprogress
